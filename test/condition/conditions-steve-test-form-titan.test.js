...
const basePath = `${FORM_PREFIX}/conditions-steve-test-form-titan`
...
describe('Form journey', () => {
  const journey = [
     ...
     */
    {
      ...
      paths: {
        ...
        current:
          '/do-you-want-to-know-more-about-permit-applications-for-the-following-types-of-activities-known-as-a1-installations-or-are-you-carrying-out-a-medium-combustion-or-specified-generator-activity',
        next: '/what-is-or-will-be-the-main-a1-installations-activity-that-you-need-pre-application-advice-about'
      },
      ...
      fields: [
        {
          ...
          payload: {
            ...
            valid: {
              mOPwGp:
                'Other: paper, pulp and board manufacture, carbon, tar and bitumen, coating activities, printing and textile treatments, food industries, intensive farming, and carbon capture & storage'
            }
          },
    ...
    {
      heading1:
        'What is or will be the main A1 installations activity that you need pre-application advice about?',
      ...
      paths: {
        ...
        current:
          '/what-is-or-will-be-the-main-a1-installations-activity-that-you-need-pre-application-advice-about',
        next: '/what-type-of-intensive-farming-permit-application-do-you-want-pre-application-advice-about'
      },
      ...
      fields: [
        {
          ...
          payload: {
            empty: { GpKNIy: '' },
            valid: {
              GpKNIy: 'Intensive farming'
            }
          },

          errors: {
            empty: 'Select other activity type'
          }
        }
      ]
    },
    ...
    {
      heading1:
        'What type of intensive farming permit application do you want pre-application advice about?',
      ...
      paths: {
        ...
        current:
          '/what-type-of-intensive-farming-permit-application-do-you-want-pre-application-advice-about',
        next: '/would-you-like-us-to-carry-out-a-free-intensive-farming-ammonia-screening-for-you-to-consider-as-part-of-your-application'
      },
      ...
      fields: [
        {
          ...
          payload: {
            empty: { htiYbK: '' },
            valid: { htiYbK: 'A new permit application' }
          },

          errors: {
            empty: 'Select intensive farming application type'
          }
        }
      ]
    }
  ...
  beforeAll(async () => {
    server = await createServer({
      formFileName: 'conditions-steve-test-form-titan.json',
